...
(window._gsQueue || (window._gsQueue = [])).push(function () {
    ...
    window._gsDefine("plugins.ThrowPropsPlugin", ["plugins.TweenPlugin", "TweenLite", "easing.Ease", "utils.VelocityTracker"], function (a, b, c, d) {
        var t, u, v, w, e = function () {
        ...
        }, f = 999999999999999, g = 1e-10, h = !1, i = {
            x: 1,
            y: 1,
            z: 2,
            scale: 1,
            ...
            l = function (a) {
            for (var b = [j, "greensock.com",".","codepen.io",
                "cdpn.io",
                "gannon.tv",
                "codecanyon.net",
                "themeforest.net",
                "cerebrax.co.uk"],
                     c = b.length; --c > -1;)if (-1 !== a.indexOf(b[c]))return !0;
            return -1 !== (window ? window.location : "").indexOf("greensock") && -1 !== a.indexOf("localhost")
            ...
            return e > c ? e = c : d > e && (e = d), {max: e, min: e, unitFactor: a.unitFactor}
        }, o = function (a, b, c) {
        ...
        return s.constructor = e, e.version = "0.9.5", e.API = 2, e._autoCSS = !0, e.defaultResistance = 100, e.defaultUnitFactors = {
            ...
            c.throwProps || (c = {throwProps: c}), 0 === f && (c.throwProps.preventOvershoot = !0), h = !0;
            var g = new b(a, 1, c);
            ...
            v = this, w = b;
            var q, r, s, t, u, x, y, z, A, e = c._ease, f = isNaN(b.checkpoint) ? .05 : Number(b.checkpoint), g = c._duration, i = b.preventOvershoot, m = 0;
            for (q in b)if ("resistance" !== q && "checkpoint" !== q && "preventOvershoot" !== q) {
                if (r = b[q], "number" == typeof r)u = Number(r) || 0; else if ("object" != typeof r || isNaN(r.velocity)) {
        ...
        var b, c, d, e, f = /([A-Z])/g, g = {}, h = {
            ...
            l = function (a) {
                for (var b = [ "greensock.com",".","codepen.io",
                    "cdpn.io",
                    "gannon.tv",
                    "codecanyon.net",
                    "themeforest.net",
        ...
        return s.addProp = function (b, c) {
            ...
            l ? q : (window.location.href = "http://" + "greensock.com" + "/requires-membership/" + "?plugin=VelocityTracker", !1)
    }, !0)
